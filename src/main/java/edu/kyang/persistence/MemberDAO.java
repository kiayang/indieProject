...
public class MemberDAO {
     ...
     */
    public List<MemberBean> getByLastName(String lastName) {

        Session session = sessionFactory.openSession();

        logger.debug("Search members by last name " + "last name =" + lastName);
     ...
     ******************************************************************************************/
    public void saveOrUpdate(MemberBean member) {
        Session session = sessionFactory.openSession();
