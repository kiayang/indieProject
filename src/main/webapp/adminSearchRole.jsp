...
<div class="container-fluid text-center">
    ...
    <div class="row content">
        ...
        <div class="col-sm-6 text-left">
            ...
            <br/>
            <h4>This page is use for searching member and their role information in the system. No entry will search for all members and related roles.</h4>
            <br/>

            <form name="searchForm" action="adminSearchRoleServlet" method="get">
